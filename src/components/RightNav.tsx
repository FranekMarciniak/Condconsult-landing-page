      ...
      <Ul open={open} activeMenu={activeMenu}>
        ...
        >
          <div className="menu" style={{ paddingTop: "10px" }}>
            ...
            <SidebarItem goToMenu="courses" goRight={true}>
              Courses
            </SidebarItem>
            <SidebarItem to="/consultation">Consultation</SidebarItem>
        ...
        >
          <div className="menu">
            <StyledListHeading onClick={() => setActiveMenu("main")}>
              <StyledLeftSpanIcon />
              Products
            </StyledListHeading>
        ...
        >
          <div className="menu">
            ...
            <SidebarItem first={true} to="/course-3">
              Course 1
            </SidebarItem>
            <SidebarItem to="/course-2">Course 2</SidebarItem>
            <SidebarItem to="/course-3">Course 3</SidebarItem>
          </div>
        </CSSTransition>
      </Ul>
    </>
